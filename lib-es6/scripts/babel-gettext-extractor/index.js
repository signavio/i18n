  ...
  return {
    visitor: {
      ...
      CallExpression: function CallExpression(_ref3, config) {
        ...
        if (replacements && (typeof replacements[translate.msgid] === 'string' || typeof replacements[translate.msgid_plural] === 'string')) {
          var newTranslate = _objectSpread(_objectSpread({}, translate), {}, {
            comments: _objectSpread(_objectSpread({}, translate.comments), {}, {
              extracted: "REPLACEMENT for \"".concat(translate.msgid, "\"").trim()
            })
          });

          newTranslate.msgid = typeof replacements[translate.msgid] === 'string' ? replacements[newTranslate.msgid] : newTranslate.msgid;
          newTranslate.msgid_plural = typeof replacements[translate.msgid_plural] === 'string' ? replacements[newTranslate.msgid_plural] : newTranslate.msgid_plural;

...
var _default = function _default(singleton) {
  ...
  function applyMarkdown() {
    ...
    var finalTranslation = (0, _marked.marked)(translation.replace(/_/g, '\\_')); // remove single, outer wrapping <p>-tag
  ...
  function insertInterpolations() {
    ...
    for (var _i = 0, _Object$entries = Object.entries(options); _i < _Object$entries.length; _i++) {
      ...
      if (key !== 'markdown' && ! /*#__PURE__*/_react["default"].isValidElement(value)) {
  ...
  function insertReactComponentInterpolations(translation, options) {
    ...
    while ((match = interpolationRegExp.exec(translation)) !== null) {
      ...
      if ( /*#__PURE__*/_react["default"].isValidElement(component)) {
        result.push( /*#__PURE__*/_react["default"].cloneElement(component, {
          key: result.length
        }));
      } else {
